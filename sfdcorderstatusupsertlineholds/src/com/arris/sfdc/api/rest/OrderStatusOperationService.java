...
@Path("/orderstatusupsertlineholds")
public class OrderStatusOperationService {
	...
	public Response vmiOrderOperation(LineHoldsInput orderStatusInput) throws ParseException{
		...
		LineHoldsOutput orderstatusOutput = null;
		try{
			
			if(orderStatusInput != null){
				orderstatusOutput = orderStatusOperationServiceProvider.performUpsertLineHolds(orderStatusInput);
			}
		}catch(LoginFault e){
