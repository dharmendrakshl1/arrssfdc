...
import com.arris.sfdc.service.provider.AttachmentCreateServiceProvider;
...
@Path("/attachmentcreate")
public class AttachmentCreateService {

	Logger logger = Logger.getLogger(AttachmentCreateService.class);
	
	@POST
	@Consumes(MediaType.APPLICATION_XML)
	@Produces(MediaType.APPLICATION_XML)
	public Response attachmentCreate(InputElement inputElement){
		logger.info("Entering - com.arris.sfdc.api.rest.AttachmentCreateService.attachmentCreate(InputElement) : "+inputElement);
		
		AttachmentCreateServiceProvider attachmentCreateServiceProvider = new AttachmentCreateServiceProvider();
		OutputElement outputElement = null;
		
		if(inputElement != null){
			try{
				outputElement = attachmentCreateServiceProvider.attachmentCreate(inputElement);
		...
		logger.info("Leaving - com.arris.sfdc.api.rest.AttachmentCreateService.attachmentCreate(InputElement) - outputElement : "+outputElement);
