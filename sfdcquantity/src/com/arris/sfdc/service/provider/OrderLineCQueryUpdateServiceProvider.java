...
public class OrderLineCQueryUpdateServiceProvider {
	...
	public UpdateOutput orderLineCQureyOrUpdate(LineDetails lineDetails) throws Exception{
		...
		if(operation != null){
			...
			//If Operation = Query 
			if(OrderLineCOperationConstants.ORDER_LINE_C_OPERATION_QUERY.equalsIgnoreCase(operation.trim())){
			...
			//If Operation = Update
			if(OrderLineCOperationConstants.ORDER_LINE_C_OPERATION_UPDATE.equalsIgnoreCase(operation.trim())){
