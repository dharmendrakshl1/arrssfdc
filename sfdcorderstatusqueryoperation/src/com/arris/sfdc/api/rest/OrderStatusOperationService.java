...
@Path("/orderstatusQueryinterface")
public class OrderStatusOperationService {
	...
	public Response vmiOrderOperation(InputElement orderStatusInput){
		...
		try{
		orderstatusOutput = orderStatusOperationServiceProvider.orderStatusOperation(orderStatusInput);
