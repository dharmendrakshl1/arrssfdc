...
import com.arris.sfdc.service.provider.OrderStatusOperationLineServiceProvider;
...
public class OrderStatusOperationService {
	...
	public Response vmiOrderOperation(LineInput orderStatusInput) throws ParseException{
		logger.info("Entering - com.arris.sfdc.api.rest.VMIOrderOperationService.vmiOrderOperation(orderStatusInput) : "+orderStatusInput);
		
		OrderStatusOperationLineServiceProvider orderStatusLine = new OrderStatusOperationLineServiceProvider();
		LineOutput orderstatusOutput = null;
		try{
			
			if(orderStatusInput != null){
				orderstatusOutput = orderStatusLine.PerformUpsertLine(orderStatusInput);
			}
		}catch(LoginFault e){
		...
		logger.info("Leaving - com.arris.sfdc.api.rest.VMIOrderOperationService.vmiOrderOperation(OrderImportInput) - orderImportOutput : "+orderstatusOutput);
