...
@XmlRootElement(name = "HeaderHoldsOutput")
public class HeaderHoldsOutput {

    @XmlElement(name = "Results", required = true)
    protected List<HeaderHoldsOutput.Results> results;
     ...
     * {@link HeaderHoldsOutput.Results }
     * 
     * 
     */
    public List<HeaderHoldsOutput.Results> getResults() {
        if (results == null) {
            results = new ArrayList<HeaderHoldsOutput.Results>();
        }
        return this.results;
    }
