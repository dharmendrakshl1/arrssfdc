...
import com.arris.sfdc.service.provider.OrderStatusOperationNoteServiceProvider;
...
public class OrderStatusOperationService {
	...
	public Response noteOperation(InputElement orderStatusInput) throws ParseException{
		logger.info("Entering - com.arris.sfdc.api.rest.NoteOperationService.noteOrderOperation(orderStatusInput) : "+orderStatusInput);
		
		OrderStatusOperationNoteServiceProvider orderStatusNote = new OrderStatusOperationNoteServiceProvider();
		OutputElement orderstatusOutput = null;
		try{
		if(orderStatusInput != null){
		
		orderstatusOutput = orderStatusNote.inputNoteOperation(orderStatusInput);
		}
		logger.info("Leaving - com.arris.sfdc.api.rest.NoteOperationService.noteOrderOperation(OrderImportInput) - orderImportOutput : "+orderstatusOutput);
